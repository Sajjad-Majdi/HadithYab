# جستجوگر حدیث با Jina

یک برنامه جستجوی معنایی که به کاربران امکان می‌دهد با وارد کردن جملات طبیعی، احادیث مرتبط را پیدا کنند. این برنامه از embeddings سرویس Jina AI برای بازیابی نتایج معنایی مشابه از یک پایگاه داده برداری مبتنی بر Supabase استفاده می‌کند.
